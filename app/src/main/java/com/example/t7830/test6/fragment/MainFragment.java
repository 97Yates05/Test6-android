...
import com.example.t7830.test6.adapter.MainHeaderAdAdapter;
import com.example.t7830.test6.adapter.MainMenuAdapter;
import com.example.t7830.test6.adapter.SecondMenuAdapter;
import com.example.t7830.test6.util.DataUtil;
...
public class MainFragment extends Fragment {
    ...
    //二级菜单图标
    private int[] menuIcons_second = {R.mipmap.menu_second_airport,R.mipmap.menu_second_play,
            R.mipmap.menu_second_quan,R.mipmap.menu_second_service,R.mipmap.menu_second_ticket,
            R.mipmap.menu_second_wifi};
    protected String[] menus;
    private String[] menus_second;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        menus_second = getActivity().getResources().getStringArray(R.array.second_menu);
        ...
        sRecycleViewMenu.setLayoutManager(linearLayoutManager);
        SecondMenuAdapter secondMenuAdapter = new SecondMenuAdapter(DataUtil.getMainMenus(menuIcons_second,menus_second));
